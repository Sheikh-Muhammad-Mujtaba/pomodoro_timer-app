...
export default function PomodoroComponent() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setAudio(new Audio("/sounds/alert.mp3"));
    }
  }, []);
  ...
  useEffect(() => {
    if (state.currentTime === 0) {
      if (soundEnabled && audio) {
        audio.play(); // Play sound when the timer hits 0
      }
      ...
      // Auto-start the next session after 5 seconds
      setTimeout(() => {
        handleSessionSwitch(); // Switch to the next session (work or break)
        setState((prevState) => ({
          ...prevState,
          timerStatus: "running", // Auto-start the timer
        }));
        ...
        <div className="flex flex-col items-center justify-center gap-6">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-2xl font-medium">
              ...
              >
                {state.currentSession === "work" ? "Work 👩‍💻" : "Break 💆‍♀️"}
              </span>
            </div>
            ...
            <CircularProgressbar
              ...
              styles={buildStyles({
                textSize: "16px",
                textColor: "#000", // Modify text color
                pathColor:
                  state.currentSession === "work" ? "#4caf50" : "#f44336", // Green for work, red for break
                trailColor: "#d6d6d6",
              })}
            />
          </div>
